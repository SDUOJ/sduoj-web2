...
const LatePermission = (props: any) => {
        ...
        },
        {
            ...
            render: (value, record) => (
                <Switch
                    ...
                    disabled={switchLoadingId === (record.permission_id ?? record.id)}
    ...
    ], [handleToggleEnabled, openEditModal, switchLoadingId, t]);
...
export default connect(
    null,
    mapDispatchToProps
)(withTranslation()(withRouter(LatePermission)));
